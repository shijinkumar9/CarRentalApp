...
const Footer = () => {
   return (
        ...
        className='p-x md:px-16 lg:px-24 xl:px-32 mt-60 text-sm text-gray-500'>
            <motion.div 
            ...
            className='flex flex-wrap justify-between items-start gap-8 pb-6 border-borderColor border-b'>
                <div className='max-w-80'>
                    ...
                    className='max-w-80 mt-3'>
                        Premium car rental service eith a wide selection of luxury and everyday vehicles for all your driving needs.
                    </motion.p>
                    <motion.div 
                    initial={{opacity:0}}
                    whileInView={{opacity:1}}
